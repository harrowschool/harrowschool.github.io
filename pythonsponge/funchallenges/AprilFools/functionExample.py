...
returnLine = -1
output = -1
goto(13) # goto the start of the main code

# start of my Range function

output = max(myList) - min(myList)

goto(returnLine) # The code is finished!
...
if i < 5:
    goto(15) # goto for looping

# calling the Range function with goto
returnLine = 25
goto(6) # goto for function call

print("The range of the numbers is", output)
"""
